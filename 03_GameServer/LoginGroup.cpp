...
void game::LoginGroup::OnRecv(uint64 sessionId, Packet packet)
{
...
void game::LoginGroup::Handle_C_GAME_LOGIN(Player& player, uint64 accountId, Token& token)
{
	Token tk;
